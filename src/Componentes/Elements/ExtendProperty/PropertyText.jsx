...
const PropertyText = ({
  ...
  const [val_valueProperty, setVal_valueProperty] = useState(null)
  ...
  const cambiaRef = (vl) => {
    if (vl) {
      const input = vl.querySelector("input")
      if (!input.tieneBlur) {
        input.tieneBlur = true
        input.addEventListener('blur', function () {
          // console.log('cambio el foco ' + name);
          // console.log('input.value ', input.value);
          actualizarPropiedad(input.value)
        });
      }
    }
  }
