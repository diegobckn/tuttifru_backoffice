...
const AsignaAgregados = ({
  ...
  const cargarPropiedad = () => {
    ...
    Shop.getProperty("producto",
      ...
      producto.idSubCategoria + "-"
      + producto.idFamilia + "-"
      + producto.idSubFamilia, "agregados", infoComercio, (resp) => {
        // console.log("respuesta del servidor", resp)
        if (resp.info != "") {
          setProductos(JSON.parse(resp.info))
  ...
  return (<Dialog open={openDialog} onClose={checkSalir}
    ...
    <DialogTitle>Agregados para {producto.nombre}</DialogTitle>
    <DialogContent>
...
export default AsignaAgregados;
